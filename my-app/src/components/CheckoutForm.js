...
import { axiosWithAuth } from '../utils/Asia/axiosWithAuth'
import qs from 'qs'

// Import Selections
import { monthOptions, yearOptions} from '../utils/Asia/cardOptions'
//import {stateOptions } from '../utils/stateOptions'
import { countries } from '../utils/Asia/Countries'
                    ...
                    if (props.shipOption) {
                        commerce.checkout.capture(props.tokenId, final)
                            .then(res => {
                                    ...
                                    Navigate.push(`/order-complete/${props.tokenId}/${res.id}`)
                                    setProcessing(false)
                            })
                            .catch(err => {
